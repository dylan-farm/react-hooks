...
module.exports = function(webpackEnv) {
  ...
  const manifestPath = (isEnvDevelopment ? paths.appPublic : paths.appBuild) + '/lib/min/manifest.json';
  // const libPath = (isEnvDevelopment ? paths.appPublic:paths.appBuild)+'/lib/min/*.js';
  // const  publicLibPath= isEnvDevelopment?'/lib/min':paths.appBuild + '/lib/min'
  // const  outLibPath = '/lib/min'
            ...
            // The preset includes JSX, Flow, TypeScript, and some ESnext features.
            {
              ...
              options: {
                ...
                plugins: [
                  ...
                  isEnvProduction && ['import', { libraryName: 'antd-mobile', style: true }],
                ].filter(Boolean),
